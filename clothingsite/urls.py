...
urlpatterns = [
    ...
    path('men_sweetshirt/', views.men_sweetshirt, name='men_sweetshirt'),
    ...
    #Password Reset
    path('password_reset/',
        auth_views.PasswordResetView.as_view(template_name='clothingsite/password_reset.html'),
        name='reset_password'),
    path('password_reset_sent/', 
        auth_views.PasswordResetDoneView.as_view(template_name='clothingsite/password_reset_sent.html'), 
        name='password_reset_done'),
    path('password_reset/<uidb64>/<token>', 
        auth_views.PasswordResetConfirmView.as_view(template_name='clothingsite/password_reset_form.html'), 
        name='password_reset_confirm'),
    path('password_reset_complete/', 
        auth_views.PasswordResetCompleteView.as_view(template_name='clothingsite/password_reset_done.html'), 
